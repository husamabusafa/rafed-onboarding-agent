      ...
      <div className="flex flex-col justify-center px-8 py-12 sm:px-12 lg:px-20 xl:px-24">
        <div className="w-full max-w-sm mx-auto lg:mx-0">
          <div className="mb-10 flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-[#002855] dark:text-white">Hayyak</span>
          </div>
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-400">
            Please enter your details to sign in (UI only).
          </p>

          <form className="mt-10 space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div>
              <label className="mb-2 block text-sm font-bold text-[#002855] dark:text-white">Email</label>
              <div className="relative">
                <IconMail className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400" />
                <input
                  type="email"
                  placeholder="name@company.com"
                  className="w-full rounded-xl border-0 bg-slate-50 py-4 pl-12 pr-4 text-slate-900 ring-1 ring-inset ring-slate-200 transition-all placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-[#E1523E] dark:bg-slate-900 dark:text-white dark:ring-slate-800 dark:focus:ring-[#E1523E]"
                />
              </div>
            </div>

            <div>
              <label className="mb-2 block text-sm font-bold text-[#002855] dark:text-white">Password</label>
              <div className="relative">
                <IconLock className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400" />
                <input
                  type="password"
                  placeholder="••••••••"
                  className="w-full rounded-xl border-0 bg-slate-50 py-4 pl-12 pr-4 text-slate-900 ring-1 ring-inset ring-slate-200 transition-all placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-[#E1523E] dark:bg-slate-900 dark:text-white dark:ring-slate-800 dark:focus:ring-[#E1523E]"
            ...
            <div className="flex items-center justify-between text-sm">
              <span className="text-slate-500 dark:text-slate-400">No authentication required</span>
      ...
      <div className="relative hidden lg:block bg-[#002855]">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-20 text-white">
          <div className="relative z-10">
            <p className="text-sm font-bold uppercase tracking-widest opacity-70">Onboarding Agent</p>
          ...
          <div className="relative z-10 rounded-3xl bg-white/10 p-6 backdrop-blur-md ring-1 ring-white/20">
            ...
            <p className="mt-2 text-sm text-blue-100">
              Visit <span className="font-bold text-white">Test Components</span> to see the full UI kit in action with sample data.
            </p>
          </div>
        </div>
