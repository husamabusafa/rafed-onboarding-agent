...
export function ActionDetailPage() {
  ...
  if (!action) {
    return (
      <div className="mx-auto max-w-lg py-12 text-center">
        <h1 className="text-2xl font-bold tracking-tight text-[#002855] dark:text-white">Action not found</h1>
        <p className="mt-2 text-slate-600 dark:text-slate-300">The requested action does not exist.</p>
        <Link
          to="/actions"
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-12 pb-12">
          ...
          {action.sessionDate && (
            <div className="shrink-0 rounded-2xl bg-slate-50 p-4 dark:bg-slate-900/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Session Date</p>
                  <p className="font-semibold text-[#002855] dark:text-white">{action.sessionDate}</p>
                </div>
              </div>
            </div>
          )}
      ...
      <section>
        <h2 className="mb-6 text-2xl font-bold tracking-tight text-[#002855] dark:text-white">Action Steps</h2>
        <div className="space-y-4">
