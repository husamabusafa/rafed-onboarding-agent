      ...
      OnboardingTaskTracker: {
        input: {
          ...
          tasks: [
            {
              taskId: 'task-1',
              titleEn: 'Pick up ID badge',
              titleAr: 'استلام بطاقة الهوية',
              descriptionEn: 'Collect your badge from HR and verify access is enabled.',
              descriptionAr: 'استلم بطاقتك من الموارد البشرية وتأكد من تفعيل الصلاحيات.',
              owner: 'HR',
              status: 'in_progress',
              dueDate: '2026-01-14',
              priority: 'high',
            },
            {
              taskId: 'task-2',
              titleEn: 'Email setup',
              titleAr: 'إعداد البريد الإلكتروني',
              descriptionEn: 'Confirm your mailbox and MFA are active.',
              descriptionAr: 'تأكد من تفعيل البريد الإلكتروني والمصادقة متعددة العوامل.',
              owner: 'IT',
              status: 'pending',
              dueDate: '2026-01-14',
              priority: 'medium',
            ...
            {
              taskId: 'task-3',
              titleEn: 'Building tour',
              titleAr: 'جولة في المبنى',
              descriptionEn: 'Get familiar with key areas (office, cafeteria, meeting rooms).',
              descriptionAr: 'تعرّف على الأماكن المهمة (المكتب، الكافيتريا، قاعات الاجتماعات).',
              owner: 'Admin',
              status: 'completed',
              priority: 'low',
              dueDate: '2026-01-13',
