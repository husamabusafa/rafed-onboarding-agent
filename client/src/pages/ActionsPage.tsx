    ...
    <div className="space-y-12 pb-12">
      <div className="max-w-3xl">
        ...
        <p className="mt-4 text-lg text-slate-600 dark:text-slate-300">
          Useful onboarding actions with clear steps, owners, and timelines.
        </p>
      </div>
        ...
        {onboardingActions.map((action) => (
          ...
          >
            <div>
              ...
              <h2 className="mt-2 text-lg font-bold tracking-tight text-slate-900 dark:text-white">{action.title}</h2>
